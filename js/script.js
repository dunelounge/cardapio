const menuData = {
    combos: {
        title: 'Combos',
        items: [
            { name: 'Combo Beefeater', description: '4 gelo + red bull sabores', price: '280,00', image: 'img/beefeter.jpg' },
            ...
            { name: 'Combo Absolut', description: '4 gelo + red bull sabores', price: '240,00', image: 'img/absolut.jpg' },
            ...
            { name: 'Combo Black Label', description: '4 gelo + red bull', price: '360,00', image: 'img/black.jpg' },
            { name: 'Combo Double Black', description: '4 gelo + red bull', price: '380,00' },
            { name: 'Combo Buchannas', description: '4 gelo + red bull', price: '380,00', image: 'img/buchanas.jpg' },
            ...
            { name: 'Combo Jack Daniels', description: '4 gelo + red bull', price: '320,00', image: 'img/jack.jpg' },
            ...
            { name: 'Combo Old Parr', description: '4 gelo + red bull', price: '320,00', image: 'img/oldpar.jpg' },
            { name: 'Combo Red Label', description: '4 gelo + red bull', price: '260,00', image: 'img/red label.jpg' },
    ...
    doses: {
        ...
        items: [
            ...
            { name: 'Dose Beefeater', description: '1 Red bull + 1 gelo sabores', price: '45,00' },
            { name: 'Dose Beefeater Pink', description: '1 Red bull + 1 gelo sabores', price: '50,00' },
            { name: 'Dose Black Label', description: '1 Red bull + 1 gelo sabores', price: '55,00' },
            { name: 'Dose Double Black', description: '1 Red bull + 1 gelo sabores', price: '60,00' },
            { name: 'Dose Buchannas', description: '1 Red bull + 1 gelo sabores', price: '55,00' },
            { name: 'Dose Chivas', description: '1 Red bull + 1 gelo sabores', price: '50,00' },
            { name: 'Dose Ciroc Blue', description: '1 Red bull + 1 gelo sabores', price: '50,00' },
            ...
            { name: 'Dose Jack Daniels', description: '1 Red bull + 1 gelo sabores', price: '50,00' },
            ...
            { name: 'Dose Old Parr', description: '1 Red bull + 1 gelo sabores', price: '45,00' },
            { name: 'Dose Red Label', description: '1 Red bull + 1 gelo sabores', price: '40,00' },
            { name: 'Dose Tanqueray', description: '1 Red bull + 1 gelo sabores', price: '50,00' },
            ...
            { name: 'Gelo Tropical', description: '', price: '7,00' },
            { name: 'Gelo Coco', description: '', price: '5,00' },
    ...
    cervejas: {
        ...
        items: [
            ...
            { name: 'Balde Budweiser Long neck (5 Unidades)', price: '55,00', image: 'img/bud.jpg' },
    ...
    longnecks: {
        title: 'Long Necks',
        items: [
            { name: 'Budweiser Long Neck', price: '12,00' },
    ...
    roshs: {
        ...
        items: [
            ...
            { name: 'Trident', price: '5,00' },
            { name: 'Halls', price: '5,00' },
        ]
    },
    softdrinks: {
        ...
        items: [
            ...
            { name: 'Red Bull', description: 'Tradicional / Sabores', price: '15,00' },
