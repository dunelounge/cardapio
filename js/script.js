const menuData = {
    combos: {
        ...
        items: [
            ...
            { name: 'Combo Ciroc Red Berry', description: '4 gelo + red bull sabores', price: '360,00', image: 'img/ciroc_sabor.jpg' },
    ...
    cervejas: {
        ...
        items: [
            ...
            { name: 'Skol Beats', price: '12,00' },
            { name: 'Cabaré Ice', price: '12,00' },
    ...
    roshs: {
        ...
        items: [
            ...
            { name: 'Essências Ziggy / Onix', description: 'Banana e açaí, Cherry, Coru magic, Frutas verdes, Tutti frutti, Grapp, Hapocalyx mint, High fusion, High herry, Hortelã, Laranja e morango, Limão, Manga tropical, Maçã, Pera, Tropical, Watermelon bomb, Frutas amarelas, Laranja, High passion, Duas goibas, Jabuticaba, Love 66', price: '25,00' },
